...
/*   Updated: 2018/07/13 13:23:31 by mfrisby          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_pos(char *s, t_plan *plan)
{
	...
	if (!tab || !tab[0] || !tab[1] || !tab[2])
		return (-1);
	plan->x = ft_getnbr(tab[0]);
	plan->y = ft_getnbr(tab[1]);
	plan->z = ft_getnbr(tab[2]);
	free(tab[0]);
	free(tab[1]);
	free(tab[2]);
	free(tab);
...
static int		get_dir(char *s, t_plan *plan)
{
	...
	if (!tab || !tab[0] || !tab[1] || !tab[2])
		return (-1);
	plan->dirx = ft_getnbr(tab[0]);
	plan->diry = ft_getnbr(tab[1]);
	plan->dirz = ft_getnbr(tab[2]);
	free(tab[0]);
	free(tab[1]);
	free(tab[2]);
	free(tab);
